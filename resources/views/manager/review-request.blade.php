        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            @if (!empty($conflicts))
                @foreach ($conflicts as $conflict)
                    ...
                    @endphp
                    <div class="mb-4 p-4 {{ $config['bg'] }} border {{ $config['border'] }} rounded-lg">
                        <div class="flex">
                            <svg class="h-6 w-6 {{ $config['icon'] }} flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                            ...
                            <div class="ml-3 flex-1">
                                ...
                                <p class="mt-1 text-sm {{ $config['detail'] }}">
                                    {{ $conflict['message'] }}
                                </p>
