    ...
    <div class="py-8">
        <div class="mx-auto max-w-3xl sm:px-6 lg:px-8">
            <div class="mb-6">
                ...
                <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Add a new employee, manager, or HR admin to the system</p>
            </div>
            ...
            <div class="overflow-hidden bg-white dark:bg-gray-800 shadow-sm sm:rounded-xl border border-gray-200 dark:border-gray-700">
                <div class="p-6">
                    <form method="POST" action="{{ route('hr-admin.users.store') }}">
                        ...
                        {{-- Password --}}
                        <div class="mb-5">
                            <label for="password" class="block text-sm font-semibold text-gray-800 dark:text-gray-200 mb-2">Password <span class="text-red-500">*</span></label>
                        ...
                        {{-- Confirm Password --}}
                        <div class="mb-5">
                            <label for="password_confirmation" class="block text-sm font-semibold text-gray-800 dark:text-gray-200 mb-2">Confirm Password <span class="text-red-500">*</span></label>
